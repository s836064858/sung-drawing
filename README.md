...
- **AI 生图**：集成火山引擎 Image Generation API，支持文生图和图生图。
- **AI 润色**：集成火山引擎 Chat API，支持对选中文本进行智能润色优化。
- **智能填充**：选中图片或文本后自动识别上下文，提升创作效率。

## 🧠 大图性能建议

当项目中存在大量大图（高分辨率素材、批量图片节点）时，可按需引入 LeaferJS 生态插件以优化内存与渲染性能：

- 插件推荐 1：https://www.pxgrow.com/plugin/view/?id=10002&d=0313
- 插件推荐 2：https://www.pxgrow.com/plugin/view/?id=10006&d=0313
